...
return [
    ...
    */
    ...
    'confirmed' => "':attribute' confirmation does not match.", #edited
    'date' => "':attribute' must be a valid date.", #edited
    ...
    'email' => "':attribute' must be a valid email address.", #edited
    ...
    'max' => [ #edited
        ...
        'file' => "':attribute' can't be more than :max kilobytes.",
        'string' => "':attribute' can't be more than :max characters.",
        'array' => "':attribute' can't be have more than :max items.",
    ],
    ...
    'regex' => "':attribute' format is invalid.", #edited
    'required' => "':attribute' is required.", #edited
    ...
    'unique' => "':attribute' value can't be used.", #edited
